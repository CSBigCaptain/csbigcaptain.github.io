...
- **大多数接口在背后**：天选、ROG 等游戏本的接口在两侧，插上网线、HDMI 线、键鼠后笔记本 C 面好似张开翅膀，适合桌面纵深较浅的用户。拯救者的多数接口在背后，放在桌面更美观。
...
> 笔记本新机「开荒」指南 - 你缺失的那门计算机课
>
> https://www.criwits.top/missing/new-laptop-setup.html

我的博客还有 [Windows 安装指南](https://blog.zhilu.site/2023/windows-setup-guide)（重装/激活/Office）、[Windows 空间管理/清理指南](https://blog.zhilu.site/2024/windows-storage)、[Windows 终端体验优化指南](https://blog.zhilu.site/2024/windows-terminal) 等，可以一读。
...
> 软件的寻找与安装 - 你缺失的那门计算机课
>
> https://www.criwits.top/missing/software-installation.html
...
压缩包是十分常用的下载格式，在打开压缩文件时，联想应用商店会弹窗推荐使用「WinZips」或「Zip 解压缩」，这类解压软件在使用时很容易触发付费选项，于是就变成“解压软件要付费”了。

打开文件提示需要安装某软件的弹窗并非系统提醒，而是联想应用商店处心积虑设计的界面。

毋庸置疑的是，联想在其中起到了推波助澜的作用：这些软件都是联想专版，借助「联想应用商店」庞大的装机量和劫持文件打开方式弹窗的推广，它们的下载量十分可观。硬要说的话，「360 压缩」甚至都比这类软件善良。不过还是建议选择 「7-Zip」等压缩软件，用户体验更好。

> 压缩工具 / 压缩软件 - 你缺失的那门计算机课
>
> [阅读](https://www.criwits.top/missing/archive-formats-and-tools.html#%E5%8E%8B%E7%BC%A9%E5%B7%A5%E5%85%B7--%E5%8E%8B%E7%BC%A9%E8%BD%AF%E4%BB%B6)
...
在解答代码问题时，我发现不少新生都装有一款「超级文本编辑器」的软件，我不解，我质询，我琢磨；望着文件选项卡和代码编辑框之间亮眼的「开通 VIP 权益提醒」横幅，我震惊，我思忖，我颤栗。

这个软件，竟然不需要开通 VIP 就能编辑代码，简直比山寨盗版的「7Z 解压缩」强了不知多少倍。

![超级文本编辑器在联想应用商店的宣传图](https://lsw-fast.lenovo.com.cn/appstore/apps/adp/img/1543-2024-05-13055800-1715594280383.png)
...
>
> https://github.com/BartoszCichecki/LenovoLegionToolkit/blob/master/README_zh-hans.md
...
<span style="font-size: 1.3em;font-weight: 300">自对一对对子（纸鹿）</span>
